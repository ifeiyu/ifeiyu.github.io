...
window.onload = function () {
    ...
    logoElem.innerHTML = '飞鱼视频 <span class="flag">FeiYu Tube</span>'
    mainElem.appendChild(logoElem);

    // newest urls
    var newestFieldElem = createFieldElem({title: '最新地址', items: newestUrls, text: '請使用https://協議訪問飛魚視頻FeiYu Tube'});
